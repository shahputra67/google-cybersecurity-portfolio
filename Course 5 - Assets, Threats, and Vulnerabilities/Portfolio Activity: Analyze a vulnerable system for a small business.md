...
Click the following link and select **Use Template: Vulnerability assessment report**.  
...
Click the following link and select **Use Template: NIST SP 800-30 Rev. 1**.  
...
Refer to the likelihood and severity sections of the NIST SP 800-30 Rev. 1 resource and ask yourself:
...
Then, estimate a **Likelihood score (1–3)** and **Severity score (1–3)** for each threat and add your scores to the corresponding columns of the Risk Assessment table in your template. After that, calculate an overall **Risk score (1–9)** for each threat using the formula:
...
#### Think about the risks that could be remediated or mitigated using controls like:
...
## Pro Tip
Save a copy of your completed activity. You can use it for your professional portfolio to demonstrate your knowledge and experience to potential employers.

---

## What to Include in Your Response
Your completed activity should include:
- 3–5 sentences describing the reasons for conducting the security analysis (Purpose section)
- A completed Risk Assessment section
- 3–5 sentences explaining your reasoning for the identified risks (Approach section)
- 3–5 sentences summarizing a remediation and/or mitigation strategy (Remediation section)

---

## Step 3 - Assess Your Activity
Use the following self-assessment to review your Vulnerability Assessment Report.  

There are **5 points total**, each worth **1 point**, corresponding to each part of the activity.
